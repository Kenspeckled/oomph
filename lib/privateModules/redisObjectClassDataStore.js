  ...
  redisObjectDataStore = {
    ...
    find: function(id) {
      ...
      modifyHashPromise = getHash.then(function(hash) {
        var attrSettings, getReferenceIdsFn, hashPromiseFn, j, len, propertyName, propertyValue, ref, referencePromise;
      ...
      p = new Promise((function(_this) {
        return function(resolve, reject) {
          ...
          if (optionName === 'id') {
            ...
            if (_this.attributes[optionName].dataType === 'string' && (_this.attributes[optionName].identifiable || _this.attributes[optionName].url)) {
        ...
        switch (this.attributes[option].dataType) {
          ...
          case 'reference':
            ...
            if (referenceModelName) {
              namespace = this.attributes[option].reverseReferenceAttribute || option;
