...
(function() {
  ...
  redisObjectDataStore = {
    ...
    where: function(args) {
      var attr, end, field, fields, integerSortedSetName, j, k, keyword, keywordSearchPromise, keywords, l, len, len1, len2, len3, len4, m, maxValue, minValue, modifyObj, modifyObjAttrs, n, namespace, option, optionValue, prepareWhereConditionPromise, ref, ref1, referenceModelName, self, sortedSetKeys, start, tempIntegerKey, unionSortedSetKeys, weight, weightOptions, whereConditionPromises;
      self = this;
      args || (args = {});
    ...
    update: function(id, updateFields, skipValidation) {
      ...
      return getOriginalObjPromise.then(function(originalObj) {
        var attr, j, len, multiPromise, namespace, newValue, obj, orderedSetName, originalIds, originalValue, ref, remove, removeValue, sortedSetName;
